...
// ⬇️ import the new Vibe Hub screen
import 'vibe_hub_screen.dart';
...
class _ExploreFeedScreenState extends ConsumerState<ExploreFeedScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("🌐 Explore Memories"),
        actions: [
          IconButton(
            tooltip: "Vibe Hub",
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const VibeHubScreen()),
              );
            },
          ),
        ],
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        // (Optional) you can read username/profile image here if needed
